            ...
            return StreamBuilder(
              ...
              builder: (context, maxWeightSnapshot) {
                if (maxWeightSnapshot.hasData) {
                  var _maxWeight = (maxWeightSnapshot.data as Event).snapshot.value;
                        ...
                        Container(
                          ...
                          child: TextButton(
                            ...
                            onPressed: () async {
                              ...
                              _totalCount += _oldCardboardCount + _newCardboardCount;
                              //wastepaper
                              ...
                              _totalCount += _oldWastepaperCount + _newWastepaperCount;
                              //glass
                              ...
                              _totalCount += _oldGlassCount + _newGlassCount;
                              //plasticLids
                              ...
                              _totalCount += _oldPlasticLidsCount + _newPlasticLidsCount;
                              //aluminiumCans
                              ...
                              _totalCount += _oldAluminiumCansCount + _newAluminiumCansCount;
                              //plasticBottles
                              ...
                              _totalCount += _oldPlasticBottlesCount + _newPlasticBottlesCount;
                              //plasticMK2
                              ...
                              _totalCount += _oldPlasticMK2Count + _newPlasticMK2Count;
                              //plasticMK5
                              ...
                              _totalCount += _oldPlasticMK5Count + _newPlasticMK5Count;
                              //plasticMK6
                              ...
                              _totalCount += _oldPlasticMK6Count + _newPlasticMK6Count;
                              //plasticBags
                              ...
                              _totalCount += _oldPlasticBagsCount + _newPlasticBagsCount;
                              //steel
                              ...
                              _totalCount += _oldSteelCount + _newSteelCount;
                              ...
                              print(_totalCount);
                              print(_maxWeight);
                              if (_totalCount > _maxWeight && widget.QRCodeData != 'PqSuf8q0suf5WyjHumtL7OOHmdc2') {
                                _database.child('misc/').update(
                                  {
                                    'maxWeight': _totalCount,
                                  },
                                );
                              }
